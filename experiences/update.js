...
module.exports.update = (event, context, callback) => {
  ...
  const params = {
    ...
    UpdateExpression: 'SET updated = :updated, zip = :zip, weather_expiration = :weather_expiration, primary_location = :primary_location, activity = :activity, upper_clothing = :upper_clothing, lower_clothing = :lower_clothing, comfort_level_result = :comfort_level_result, comfort_level_prediction = :comfort_level_prediction',
